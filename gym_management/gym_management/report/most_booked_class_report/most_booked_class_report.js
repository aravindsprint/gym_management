...
frappe.query_reports["Most Booked Class Report"] = {
	"filters": [
		{
			fieldname: "tree_type",
			label: __("Tree Type"),
			fieldtype: "Select",
			// options: ["Gym Class", "Gym Trainer"],
			options: ["Gym Class"],
			default: "Gym Class",
			reqd: 1
		},
		...
		},
		{
			...
			fieldtype: "Select",
			options: [
				{ "value": "Quantity", "label": __("No of Class") },
			],
			default: "Quantity",
			reqd: 1
		},
		...
		return Object.assign(options, {
			...
			events: {
				onCheckRow: function (data) {
					...
					//const slice_at = { Gym Class: 4, Gym Trainer: 5 }[tree_type] || 3;
